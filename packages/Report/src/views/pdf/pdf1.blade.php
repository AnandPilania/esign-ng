            ...
            <div class="assen__info">
                <ul class="table-info">
                    <li>
                        ...
                        <div class="table-info__td">第一三共第一三共第一三共</div>
                    </li>
                    <li>
                        <div class="table-info__th">商品名</div>
                        <div class="table-info__td">マキロンS</div>
                    </li>
                    <li>
                ...
                <div class="p-15">
                    ...
                    <ul class="efficacy">
                        <li>
                            ...
                            <div class="efficacy__content">傷口につきにくい特殊加工パット。水の中でもはがれにくい</div>
                        </li>
                        <li>
