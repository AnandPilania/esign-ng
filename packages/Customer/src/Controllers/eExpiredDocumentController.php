...
class eExpiredDocumentController extends eCBaseController
{
    ...
    {
        try {
            $result = $this->documentHandlerService->initDocumentList(DocumentHandler::Expired);//2: tai lieu da het han
    ...
    public function searchDocumentList(Request $request)
    {
        try {
            ...
            $result = $this->documentHandlerService->searchDocumentList($searchData, $draw, $start, $limit, $sortQuery, DocumentHandler::Expired);
            return $this->sendResponse($result, '');
        } catch (Exception $e) {
    ...
    public function deleteMultiDocumentList(Request $request)
    {
        try {
            ...
            $result = $this->documentHandlerService->deleteDocumentListSetting($ids, DocumentHandler::Expired);
    ...
    public function sendMultiDocumentList(Request $request)
    {
        try {
            ...
            $result = $this->documentHandlerService->sendDocumentListSetting($postData, DocumentHandler::Expired);
