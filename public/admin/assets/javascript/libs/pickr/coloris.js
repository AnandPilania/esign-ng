...
(function (window, document, Math) {
   ...
   */
  function updateColor(rgba, hsva, str) {if (rgba === void 0) {rgba = {};}if (hsva === void 0) {hsva = {};}
    ...
    var colorTheme = [];
    colorTheme['#206bc4'] = 'primary';
    colorTheme['#ae3ec9'] = 'purple';
    colorTheme['#d6336c'] = 'pink';
    colorTheme['#ed1a36'] = 'red';
    colorTheme['#f59f00'] = 'yellow';
    colorTheme['#74b816'] = 'lime';
    colorTheme['#0ca678'] = 'teal';
    colorTheme['#17a2b8'] = 'cyan';
    colorTheme['#f4f6fa'] = 'light';
    colorTheme['#232e3c'] = 'dark';
    ...
    switch (format) {
      case 'color':
        colorValue.value = colorTheme[hex];
        break;
      case 'hex':
  ...
  function init() {
    ...
    '<input id="clr-f4" type="radio" name="clr-format" value="color">' +
    '<label for="clr-f3">HSL</label>' +
    '<span></span>' +
    '</fieldset>' +
    '</div>' +
